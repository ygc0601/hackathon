...
const STATIC_INSTRUCTIONS = [
  ...
  '</role>',
  '<goal>',
  'OCR 문서를 짧게 요약하지 말고, 원문의 의미와 중요 정보를 지킨 쉬운 글로 다시 쓴다.',
  '</goal>',
  '<rules>',
  ...
  '</rules>',
  '<relevance>',
  '남김: 목적·행동·대상·기한·장소·방법·준비물·돈·조건·결과·주의와 필요한 기관·이름·연락처.',
  ...
  '</ocr>',
  '<check>',
  '내부적으로 목적과 필수 정보를 찾고 불필요한 반복을 뺀 뒤 초안을 쓴다. 이름·숫자·부정·조건·누락·문장 길이를 원문과 대조해 고친 최종본만 출력한다.',
  '</check>',
  '<output>',
  'summary: 문서 목적을 8어절 이내 한 문장으로 쓴다.',
  'sentences: 최종 쉬운 설명을 행동 순서대로 쓴다. 번호·기호·이모지를 넣지 않는다.',
  ...
  '</output>',
  '<example>',
  '원문: 질문에 사실대로 알려야 하며, 위반하면 보험회사는 보장제한이 가능합니다.',
  '결과: {"summary":"보험 질문 안내예요.","sentences":["질문에 진짜 있었던 일을 그대로 알려야 해요.","거짓으로 답하면 보험회사가 주는 도움을 줄일 수 있어요."],"criticalSentenceNumbers":[1,2],"uncertainParts":[]}',
  '</example>',
].join('\n')
